...
import { WHATSAPP_NUMBER, COMPANY_PHONE_DISPLAY } from '@/lib/constants/contact';
    ...
    return (
        <header className="bg-brand-color-02 backdrop-blur-xl border-b border-white/50 sticky top-0 z-50 shadow-sm pt-[env(safe-area-inset-top)]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <a
                        href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi,%20Pawpaths,%0a%0aI%20want%20to%20know%20more%20about%20the%20pet%20relocation%20services.%0aPlease%20call%20me%20back...`}
                        target="_blank"
                    ...
                    >
                        ...
                        <div className="hidden sm:flex flex-col items-start leading-tight">
                            ...
                            <span className="text-sm font-bold text-gray-900">{COMPANY_PHONE_DISPLAY}</span>
                        </div>
                    </a>
