    ...
    return (
        <div className={`relative ${className}`}>
            <input
                ...
                placeholder=" "
                className={`
          peer block w-full rounded-t-md3-xs border-b border-outline bg-surface px-4 pb-2.5 pt-6 text-body-large text-on-surface focus:border-b-2 focus:border-brand-color-01 focus:outline-none placeholder:text-transparent focus:placeholder:text-brand-text-02/60
