...
/**
 * Uploads a user avatar to Supabase Storage (bucket: avatars, folder: users/).
 * Stores the full public URL in profiles.avatar_url.
...
async function uploadToS3(buffer, filename, folder, contentType) {
    ...
    const command = new PutObjectCommand({
        ...
        // No ACL — private by default. Use presigned URLs for access.
    });
