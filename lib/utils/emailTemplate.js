        ...
        <div class="content">
          ...
          <div class="section">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px;">
              <tr>
                ...
                <td style="padding: 8px; border: 1px solid #ddd; width: 50%;"><strong>Date:</strong> ${new Date().toLocaleDateString()}</td>
              </tr>
              <tr>
          ...
          <div class="section">
            ...
            <div style="background-color: #fff2b1; color: #4d341a; padding: 12px; border-radius: 4px; text-align: center; font-weight: bold; font-size: 18px; border: 1px solid #d6d8db; margin-bottom: 15px;">
              Date of Travel: ${new Date(travelDetails.travelDate).toLocaleDateString()}
            </div>
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                <td colspan="2" style="padding: 8px; border: 1px solid #ddd;"><strong>Client Traveling with Pet:</strong> ${travelDetails.clientTravelingWithPet === 'yes' ? 'Yes' : 'No'}</td>
              </tr>
            </table>
          </div>
