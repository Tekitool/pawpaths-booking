...
const LOGO_WHITE = 'https://www.pawpathsae.com/pplogo-white2.svg';
...
export function generateEmailTemplate(booking, type = 'customer') {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:10px;">
    <tr>
      ...
      : `<div style="width:52px;height:52px;background:${C.orangeLight};border-radius:50%;text-align:center;font-size:24px;line-height:52px;color:#BA8C63;">🐾</div>`
    }
            </td>
  ...
  <tr>
    <td style="background:${C.offWhite};border-top:1px solid ${C.border};padding:28px 40px;text-align:center;">
      ...
      <p style="margin:0 0 12px;font-size:12px;color:${C.textMuted};">Dubai, United Arab Emirates</p>
      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background:${C.white};border-radius:16px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background:${C.orange};padding:28px 40px;text-align:center;">
            <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:${C.white};letter-spacing:-0.3px;">Your Pet's Journey Begins Here <span style="color:#BA8C63;">🐾</span></h1>
